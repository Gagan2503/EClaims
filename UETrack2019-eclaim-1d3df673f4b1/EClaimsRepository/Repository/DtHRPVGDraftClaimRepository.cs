...
{
    public class DtHRPVGDraftClaimRepository : RepositoryBase<DtHRPVGClaimDraft>, IDtHRPVGDraftClaimRepository
    {
        public DtHRPVGDraftClaimRepository(RepositoryContext repositoryContext, IApplicationReadDbConnection readDbConnection, IApplicationWriteDbConnection writeDbConnection)
  : base(repositoryContext, writeDbConnection, readDbConnection)
        ...
        public Task<DtHRPVGClaimDraft> GetDtHRPVGClaimByIdAsync(int? hRPVGCItemID)
        {
            throw new NotImplementedException();
        }
        ...
        public async Task<List<DtHRPVGClaimDraft>> GetDtHRPVGClaimByIdAsync(long? hRPVGCID)
        {
